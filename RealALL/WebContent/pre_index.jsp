...
<body>
	...
	<div class="container">
		<div class="row-noneflex">
			<div class="main orizin">


				<section class="another">
					<h2>All of Clinical Trials</h2>
					<p>
				...
				<section class="advertisement">
					<div class="adsection">
						<h2>임상시험이란 무엇일까요?</h2>
						<p>
							왜 임상시험을 시행할까요?<br>어려움을 겪는 환자에게 새로운 희망을 심어주는 임상시험!<br>안전하고
							윤리적인 임상시험 절차에 대해 알려드립니다.
						</p>
						<a>자세히보기</a>
					</div>
					<div class="adsection-mobile">
						<h2>임상시험이란 무엇일까요?</h2>
						<p>
							왜 임상시험을 시행할까요?<br>어려움을 겪는 환자에게  희망주는 임상시험!<br>안전하고
							윤리적인 임상시험 절차를 알려드립니다.
						</p>
						<a>자세히보기</a>
					</div>
				</section>
					...
					<section class="another">
						...
						<h2>시험공고 찾아보기</h2>
						<p class="mgb-30">지금 바로 나에게 맞는 공고를 찾아보세요.</p>
				...
				<!---left:336.5px  width:1903px -->
				<section class="notice">

					<div class="section-header">
						<h2>공지사항</h2>
						<p>ALLCT의 주요 공지사항과 뉴스정보입니다.</p>
					</div>
					<div class="row">
						<div class="notice">
							<ul class="nav nav-tabs">
								...
								<li class="green"><a class="active" data-toggle="tab"
									href="#London">London</a></li>
								<li><a data-toggle="tab" href="#Paris">Paris</a></li>

							</ul>
							<div class="tab-content">
								<div id="London" class="tab-pane fade in active show">
									<p>
										공지사항입니다. 공지사항입니다. 공지사항입니다.
									</p><span>2018.10.06</span>
									<p>
										공지사항입니다. 공지사항입니다. 공지사항입니다.
									</p><span>2018.10.06</span>
									<p>
								...
								<div id="Paris" class="tab-pane fade">
									<p>
										교육 및 뉴스 입니다. 교육 및 뉴스 입니다.</p><span>2018.10.06</span>
				...
				<section class="incarousel">
					<div class="section-header">
						<h2>Allct의 파트너</h2>
						<p>여러 협력병원들이 ALLct와 함께하고 있습니다.</p>
					</div>
