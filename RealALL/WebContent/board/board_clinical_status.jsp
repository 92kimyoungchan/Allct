					...
					<div class="subP-clinical">
						...
						<div class="clinical_content_box">
							...
							<div class="clinical_content">
								...
								<div class="clinical_content_body">
									<p>임상시험 지원자가 해당 임상시험에 적합한지 확인하기 위한 신체검사를 받습니다.
									사전 검사 항목은 연구에 따라 다르며, 문진, 채혈/채뇨검사를 비롯해 신체 측정 및 혈압, 맥박 등의
									검사가 약 30분 정도 시행됩니다. 사전검사가 정확히 이루어질 수 있도록 검사 전
									지나친 운동이나 음주는 피하는 것이 바람직합니다.</p>
								</div>
							</div>
						</div>
